      ...
      <ImageBackground source={require("../../assets/fondo.jpeg")} style={styles.imageBackground}>
        <View style={styles.overlay}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Haz tu pedido, paga de manera virtual y
              recibe tu ticket de turno.</Text>
          </View>

          <TouchableOpacity style={styles.skipButton} onPress={handleSkip}>
            <Text style={styles.skipButtonText} onPress={goToQuarter}>Omitir</Text>
          </TouchableOpacity>

          {/* <View style={{ marginTop: 180, marginLeft: 250 }}>
            <Button title="Siguiente" onPress={goToQuarter} />
          </View> */}
