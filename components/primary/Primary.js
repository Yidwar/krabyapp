      ...
      <ImageBackground source={require("../../assets/fondo.jpeg")} style={styles.imageBackground}>
        <View style={styles.overlay}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Retira tu pedido con el ticket digital en tu
              resturante preferido.</Text>
          </View>

          <TouchableOpacity style={styles.skipButton} onPress={handleSkip}>
            <Text style={styles.skipButtonText} onPress={goToSecond}>Omitir</Text>
          </TouchableOpacity>

          {/* <View style={{ marginTop: 180, marginLeft: 250 }}>
            <Button title="Siguiente" onPress={goToSecond} />
          </View> */}
        </View>
      </ImageBackground>
